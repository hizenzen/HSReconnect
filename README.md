...
# Installation
1. Download the latest plugin from [Releases page](https://github.com/hizenzen/HSReconnect/releases)
...
5. The old plugin "HDT-Reconnector.dll" and the "zh-CN" folder can be safely deleted from the plugins folder before adding this one
